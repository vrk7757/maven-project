...
steps {git branch: 'may-k8s-demo', url: 'https://github.com/prakashk0301/maven-project'}
  ...
  {steps
   {kubernetesDeploy configs: 'k8s-may-cicd.yml', deleteResource: true, kubeConfig: [path: ''], kubeconfigId: 'KUBERNETES_CLUSTER_CONFIG_MAY', secretName: '', ssh: [sshCredentialsId: '*', sshServer: ''], textCredentials: [certificateAuthorityData: '', clientCertificateData: '', clientKeyData: '', serverUrl: 'https://']}
